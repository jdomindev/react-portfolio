const projects = [
    ...
    },
    {
        ...
        "description": "Day scheduler that renders HTML dynamically using jQuery and Bootstrap. The app also utilizes Moment library and stores values in local storage.",
    ...
    },
    {
        ...
        "description": "Generator that takes in user input for password prerequisites and then generates a random password on the page.",
    ...
    },
    {
        ...
        "description": "Weather app that utilizes data fetched from OpenWeatherMap API.",
    ...
    },
    {
        "id": 5,
        "title": "Tech Blog",
        "description": "Tech blog built out following the MVC paradigm and utilizing Handlebars.js, Sequelize, and express-session for authentication.",
    ...
    },
    {
        "id": 6,
        "title": "Tandom-Fandom",
        "description": "A people finding app designed for those seeking others with similar fandom interests.",
