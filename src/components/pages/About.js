                ...
                <div className="container">
                    <div className="row mb-3 profile">
                        <div className="col-md-6 profile-img">
                          <img className="img-size w-50" src="/images/profile-image.jpg" alt="profile of Jose Dominguez"></img>
                        </div>
                        <div className="card about-me-card col-md-6 profile-text">
...
// remove w-50 from profile image and add styles